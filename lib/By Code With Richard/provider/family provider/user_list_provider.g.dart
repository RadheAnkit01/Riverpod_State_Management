...
String _$userHash() => r'5eb19cbfa83120028df80a5e9e6763455c992ff9';
...
class UserFamily extends Family<User> {
  ...
  /// See also [user].
  UserProvider call(int id, int age, {String? userName}) {
    return UserProvider(id, age, userName: userName);
  }
...
class UserProvider extends AutoDisposeProvider<User> {
  /// See also [user].
  UserProvider(int id, int age, {String? userName})
    : this._internal(
        (ref) => user(ref as UserRef, id, age, userName: userName),
        from: userProvider,
        name: r'userProvider',
  ...
  @override
  Override overrideWith(User Function(UserRef provider) create) {
